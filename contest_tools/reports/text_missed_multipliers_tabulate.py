# Contest Log Analyzer/contest_tools/reports/text_missed_multipliers_tabulate.py
#
...
class Report(ContestReport):
    ...
    """
    report_id: str = "missed_multipliers_tabulate"
    report_name: str = "Missed Multipliers Report (tabulate)"
