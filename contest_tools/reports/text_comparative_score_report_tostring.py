# Contest Log Analyzer/contest_tools/reports/text_comparative_score_report_tostring.py
#
...
#          serves as a proof-of-concept for using pandas.to_string().
#
# Author: Mark Bailey, KD4D
# Contact: kd4d@kd4d.org
# Date: 2025-08-24
# Version: 0.40.13-Beta
#
...
# License, v. 2.0.
# --- Revision History ---
## [0.40.13-Beta] - 2025-08-24
### Changed
# - Reordered logic to generate the table string first, allowing the main
#   titles to be correctly centered over the final table width.
# - Replaced NaN values in the per-band 'On-Time' column with blank strings.
## [0.40.12-Beta] - 2025-08-24
### Added
...
class Report(ContestReport):
    """
    Generates a comparative, interleaved score summary report (pandas.to_string version).
    """
    report_id: str = "comparative_score_report_tostring"
    report_name: str = "Comparative Score Report (to_string)"
    ...
    def generate(self, output_path: str, **kwargs) -> str:
        ...
        # --- Report Generation using pandas.to_string() ---
        ...
        for key in sorted_keys:
            ...
            table_string = summary_df.to_string(index=False, formatters=formatters, header=True)
        ...
        total_table_string = total_df.to_string(index=False, formatters=formatters, header=True)
