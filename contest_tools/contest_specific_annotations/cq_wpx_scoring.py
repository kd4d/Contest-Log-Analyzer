...
def _calculate_points_single_qso(
    ...
    # No points for same country QSOs on high bands
    if band in ['80M', '40M'] and worked_dxcc_name == my_dxcc_name:
        return 0
    ...
    elif worked_continent == my_continent and worked_dxcc_name != my_dxcc_name:
        if band in ['160M', '80M', '40M']: return 2
        if band in ['20M', '15M', '10M']: return 1

    elif worked_dxcc_name == my_dxcc_name:
        if band in ['160M', '80M', '40M']: return 1
        if band in ['20M', '15M', '10M']: return 0
