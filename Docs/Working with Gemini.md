...
1.  **Declaration:** At the beginning of the chat, the AI will first state its intent to modify multiple files, list all the files that will be affected by the change, and state the **total number of bundles** that will be sent (e.g., "This is bundle 1 of 3" or "This is bundle 1 of 1").
...
3.  **Sequential Delivery:** At the beginning of each subsequent response, the AI will provide a status update (e.g., "This is bundle 2 of 3."). The AI will then provide the file or bundle. The response will end with a clear statement, such as: "Please confirm when you are ready for the next file/bundle."
