...
#### How to Interpret This Report
This is a key report for analyzing pacing. A strong start with a high number of new multipliers is common. A lull in the middle hours followed by a second peak can indicate a successful search for late-opening multipliers. Comparing your hourly multiplier rate to others can reveal differences in S&P strategy.
---
...
### QSO Breakdown Chart (`chart_qso_breakdown`)
