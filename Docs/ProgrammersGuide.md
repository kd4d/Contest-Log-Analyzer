...
* `Contest-Log-Analyzer/` (Project Root)
    ...
    * `reports/` (Generated Directory)
        * This directory is automatically created by the program to store all generated reports and charts in a structured path: `reports/YYYY/CONTEST_NAME/EVENT_ID/CALLSIGN_COMBO/`.
---
