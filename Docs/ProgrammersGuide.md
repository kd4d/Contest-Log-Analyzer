...
- `UsersGuide.md` - Version: 1.0.0-alpha.11
- `InstallationGuide.md` - Version: 1.0.0-alpha.11
- `ReportInterpretationGuide.md` - Version: 1.0.0-alpha.11

### Programmer Reference (Category B - Match Project Version)
- `ProgrammersGuide.md` - Version: 1.0.0-alpha.11
- `PerformanceProfilingGuide.md` - Version: 1.0.0-alpha.11

### Algorithm Specifications (Category C - Independent Versioning)
- `CallsignLookupAlgorithm.md` - Version: 0.90.11-Beta (Compatible with: up to v1.0.0-alpha.11)
- `RunS&PAlgorithm.md` - Version: 0.47.4-Beta (Compatible with: up to v1.0.0-alpha.11)
- `WPXPrefixLookup.md` - Version: 0.70.0-Beta (Compatible with: up to v1.0.0-alpha.11)
...
- Embedded via nested iframes: `qso_dashboard.html` ΓåÆ `report_viewer.html` ΓåÆ HTML file
...
- `score_formula`: Scoring calculation method:
  - `"points_times_mults"`: Standard formula (QSO points ├ù multipliers)
  - `"qsos_times_mults"`: QSO count ├ù multipliers (e.g., NAQP)
...
1. If `custom_parser_module` is specified in JSON ΓåÆ Custom parser is used
2. Otherwise ΓåÆ Standard parser uses `exchange_parsing_rules` from JSON

**Examples:**
- `cq_ww_cw.json`: No `custom_parser_module` ΓåÆ Uses standard parser
- `arrl_dx_cw.json`: Has `custom_parser_module: "arrl_dx_parser"` ΓåÆ Uses custom parser (because W/VE and DX have different exchange formats)
...
- Check error messages carefullyΓÇöthey often point to the exact issue
