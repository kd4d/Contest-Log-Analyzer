# Alpha Release Notice: v1.0.0-alpha.15
...
This release adds **QSO and Points** options for rate reports and dashboards, **CQ WPX** public log support, and **Points** views for cumulative difference plots. Everything is backward compatible; no action required for existing sessions.
...
4. **Single-log and non–points-based contests**  
...
For complete technical details and file-level changes, see the [Full Release Notes](RELEASE_NOTES_1.0.0-alpha.15.md).
