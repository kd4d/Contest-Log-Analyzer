# VPS Update Instructions: v1.0.0-alpha.21

**Release Date:** June 21, 2026  
**Target Version:** v1.0.0-alpha.21
...
3. **`git checkout v1.0.0-alpha.21`** - Switch to the v1.0.0-alpha.21 release
...
3. **Visit your website:**
   ...
   - Run an IARU-HF or WRTC comparison
   - Open **Missed Multipliers** text reports — they should generate (alpha.20 could fail with an error)
   - Open the **Multiplier Dashboard** and confirm summary/spectrum charts look normal
...
If you need to rollback to the previous version (v1.0.0-alpha.20):
...
- **Missed multipliers fix:** Text reports generate again after alpha.20 regression
- **Multiplier dashboard refactor:** Shared chart partials (internal; no intentional UI change)
...
- Re-run analysis if missed multiplier reports failed on alpha.20
...
- Missed multiplier text reports generate successfully
